...
description: Detecting repeated transactions kept deliberately beneath regulatory cash transaction reporting thresholds.
---
...
```json
{
  "skill": "structuring-smurfing-detection",
  "status": "completed",
  "confidence": 0.95,
  "findings": []
}
